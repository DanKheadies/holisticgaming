...
const DysregulatedGaming = props => (
    <AccordionCard
    ...
    >
        ...
        <p>
            <a href="https://journals.sagepub.com/doi/full/10.1177/2167702619859341" alt="Motivational and Psychosocial Dynamics of Dysregulated Gaming" className="primary-link">
        ...
        <p>
            Adolescents get just as frustrated at games as they do in life.
        </p>
        <h6>
            eli5
        </h6>
