...
const AI4Depression = props => (
    ...
    >
        ...
        <p>
            The study consisted of 74 participants who averaged 23 years old with over two-thirds of them female. Participants were put into 1 of 3 groups: an experimental group that used an integrative psychological artificial intelligence&mdash;Tess&mdash;to deliver personalized conversations over 2 weeks via an instant messenger app, a second group that used Tess for 4 weeks, and a control group that was given the National Institute of Mental Health's (NIMH) eBook. Participants were given a set of questionnaires before and after the experiment windows, which included a health questionnaire, anxiety disorder, positive and negative affect schedule, and satisfaction and engagement during the study.
        </p>
        <p>
